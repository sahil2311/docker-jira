...
ENV JIRA_DOWNLOAD_URL            "https://downloads.atlassian.com/software/jira/downloads/atlassian-jira-core-7.11.2.tar.gz"
...
RUN set -ex \
    ...
    && tar zxf $ARCHIVE --strip-components=1 -C $JIRA_CATALINA/lib/ mysql-connector-java-8.0.11/mysql-connector-java-8.0.11.jar \
    && rm -rf $ARCHIVE
