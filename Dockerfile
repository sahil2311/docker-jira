...
ENV JIRA_DOWNLOAD_URL            "https://downloads.atlassian.com/software/jira/downloads/atlassian-jira-core-7.11.0.tar.gz"
...
RUN set -ex \
    ...
    && tar zxf $ARCHIVE --strip-components=1 -C $JIRA_CATALINA/lib/ mysql-connector-java-5.1.46/mysql-connector-java-5.1.46-bin.jar \
    && rm -rf $ARCHIVE
